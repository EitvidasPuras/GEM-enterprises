...
@section('content')
    <a href="{{route('items.index')}}" class="btn btn-default">Go back</a>
    <h1>Update product</h1>
    <hr>

    {!! Form::open(['action'=>['AdminPageItemsController@update',$item->id],'method'=>'POST','enctype'=>'multipart/form-data']) !!}
    {{ csrf_field() }}
    {{ method_field('PUT') }}
